...
namespace Sitecore.Ship.Core
{
    public class PackageRepository : IPackageRepository
    {
        ...
        {
            return _packageRunner.Execute(package.Path, package.DisableIndexing, package.EnableSecurityInstall, package.AnalyzeOnly, package.SummeryOnly, package.Version);
        }
    }
}